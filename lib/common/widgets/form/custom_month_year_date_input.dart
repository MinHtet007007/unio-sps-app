...
class CustomMonthYearDateInput extends StatefulWidget {
  ...
  const CustomMonthYearDateInput({
    Key? key,
  ...
  @override
  _CustomMonthYearDateInputState createState() =>
      _CustomMonthYearDateInputState();
}

class _CustomMonthYearDateInputState extends State<CustomMonthYearDateInput> {
  late DateTime now;
