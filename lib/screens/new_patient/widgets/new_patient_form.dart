                    ...
                    child: Form(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 10),
                            CustomTextInput(
                              inputController: controllers['rrCode']
                                  as TextEditingController,
                              labelText: 'RR code',
                            ...
                            CustomTextInput(
                                ...
                                labelText: 'DRTB code',
                                isRequired:
                                    controllers['rrCode']!.text.isEmpty),
                            const SizedBox(height: 10),
                            // CustomTextInput(
                            //     inputController:
                            ...
                            const SizedBox(height: 10),
                            CustomTextInput(
                                inputController: controllers['name']
                                    as TextEditingController,
                                labelText: 'နာမည်',
                                type: 'text',
                                isRequired: true),
                            ...
                            CustomTextInput(
                                inputController: controllers['address']
                                    as TextEditingController,
                                labelText: 'လိပ်စာ',
                                type: 'text',
                                isRequired: true),
                            ...
                            CustomTextInputWithValidation(
                                inputController: controllers['phone']
                                    as TextEditingController,
